...
const PRODUCT_IMAGES = {
  // Bags
  'Chanel Classic Flap Vintage':        '/pictures/chanel-classic-flap.png',
  'Chanel 25 Cherry Red Medium':        '/pictures/chanel-25-cherry-red.png',
  'Chanel Denim Pink Flap':             '/pictures/chanel-denim-pink.png',
  'Hermès Birkin 30':                   '/pictures/hermes-birkin-30.png',
  'Hermès Birkin 25':                   '/pictures/birkin30.png',
  'Hermès Kelly 20 Sellier Framboise':  '/pictures/hermes-kelly-framboise.png',
  'Lady Dior Cherry Red Medium':        '/pictures/lady-dior.png',
  'Louis Vuitton Capucines Mini':       '/pictures/lv-capucines.png',
  'Louis Vuitton Speedy 30':            '/pictures/lv-speedy.png',
  'Saint Laurent Sac de Jour':          '/pictures/ysl-bag.png',
  // Watches
  'Bvlgari Serpenti Seduttori':   '/pictures/bvlgari-serpenti.png',
  'Cartier Panthère de Cartier':  '/pictures/cartier-panthere.png',
  'Cartier Tank Louis':           '/pictures/cartier-tank-louis.png',
  'Patek Philippe Calatrava':     '/pictures/patek-calatrava.png',
  'Richard Mille RM 07-01':       '/pictures/richard-mille-rm07.png',
  'Rolex Datejust 36':            '/pictures/rolex-datejust-new.png',
  // Clothing
  'Dior Bar Jacket':                   '/pictures/dior-jacket-new.png',
  'Chanel Tweed Dress':                '/pictures/chanel-dress.png',
  'Louis Vuitton Tailored Trousers':   '/pictures/lv-pants.png',
  'Miu Miu Mohair Cardigan':           '/pictures/miumiu-cardigan.png',
  'Prada A-Line Mini Skirt':           '/pictures/prada-skirt.png',
  // Perfumes
  'Byredo Mojave Ghost Intense':              '/pictures/byredo-mojave.png',
  'Parfum de Marly Athalia':                  '/pictures/parfum-marly-athalia.png',
  'Tom Ford Oud Wood 100ml':                  '/pictures/tom-ford-oud.png',
  'Vanilla Powder Intense — Matière Première': '/pictures/vanilla-powder.png',
  // Shoes
  'Cesare Paciotti Crystal Heels':   '/pictures/cesare-paciotti.png',
  'Jimmy Choo Azia 100 Heels':       '/pictures/jimmy-choo.png',
  'Christian Louboutin Pigalle 120': '/pictures/louboutin.png',
  'Miu Miu Cherry Red Kitten Heels': '/pictures/miumiu-kitten.png',
  'Miu Miu x New Balance Sneakers':  '/pictures/miumiu-nb.png',
  'YSL Opyum Black Heels':           '/pictures/ysl-heels.png',
};

const CATEGORY_IMAGES = {
  bags:     '/pictures/chanel-classic-flap.png',
  watches:  '/pictures/rolex-datejust-new.png',
  clothing: '/pictures/dior-jacket-new.png',
  perfumes: '/pictures/byredo-mojave.png',
  shoes:    '/pictures/louboutin.png',
...
function initCursor() {
  ...
  // Halo suit la souris avec léger lag
  ...
  // Hover sur éléments interactifs → halo s'agrandit
